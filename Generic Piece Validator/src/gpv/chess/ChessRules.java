...
public class ChessRules {
	...
	private static Behavior pawnBehavior = (from, to, board) -> {
		...
		if(piece.getColor() == PlayerColor.BLACK && changeX != -1) { //if the player is black make sure they are moving the right way
			return false;
		}
		
		if(piece.getColor() == PlayerColor.WHITE && changeX != 1) { //if they are white, make sure they are moving the right way
			return false;
		}
